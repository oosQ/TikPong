...
func LikeCommentHandler(w http.ResponseWriter, r *http.Request) {
	...
	err := services.LikeComment(userCtx.ID, commentID)
	if err != nil {
		utils.SendError(w, err.Error(), http.StatusBadRequest)
		return
	}

	utils.SendSuccess(w, dto.CommentActionResponse{CommentID: commentID, Action: "liked"}, "Comment liked successfully")
}
