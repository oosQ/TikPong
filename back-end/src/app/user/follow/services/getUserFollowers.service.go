...
func GetUserFollowers(currentUserID, targetUserID, cursor string, limit int) (*dto.GetFollowInfoResponse, error) {
	...
	return repo.GetFollowers(targetUserID, cursor, limit)
}
